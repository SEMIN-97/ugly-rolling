...
function Index() {
  ...
  return (
    <CommonLayout>
      {
        isShowSplashVideo && <video ref={videoRef} className={`splashVideo ${isFadingOut ? 'fade-out' : ''}`} src="/assets/videos/loading_screen.mp4" muted autoPlay playsInline onLoadedData={handleVideoLoad} />
      }
      <h1>Index Page</h1>
    </CommonLayout>
  );
